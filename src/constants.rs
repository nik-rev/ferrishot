...
pub const FRAME_COLOR: Color = iced::color!(0xab_61_37);
/// First shadow to draw (stronger, but smaller)
pub const DROP_SHADOW_COLOR: Color = iced::color!(0x00_00_00, 0.5);
...
pub const NON_SELECTED_REGION_COLOR: Color = iced::color!(0x00_00_00, 0.4);

/// Color used for the icons
pub const ICON_COLOR: Color = iced::color!(0xff_ff_ff);
/// Color to use for the background of icons
pub const ICON_BACKGROUND: Color = iced::color!(0xab_61_37);
