...
set edit:completion:arg-completer[ferrishot] = {|@words|
    ...
    var completions = [
        &'ferrishot'= {
            ...
            cand --log-level 'Choose a miniumum level at which to log'
            cand --log-file 'Path to the log file'
            cand --log-filter 'Filter for specific Rust module or crate, instead of showing logs from all crates'
            ...
            cand --log-stderr 'Log to standard error instead of file'
            cand --debug 'Launch in debug mode (F12)'
